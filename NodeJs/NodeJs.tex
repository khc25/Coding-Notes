...
The best way to understand this concept is through a hypothetical scenario of doing a bank transfer between two person, Alice and Bob. Let’s say Alice has $1000 in her account, she wants to transfer it to Bob. Therefore she logged in to the E-Banking platform to perform the transfer. There are two trivial steps for this transfer which are as follow,\\

\begin{enumerate}
\item Withdraw $\$1000$ from Alice Account
\item Deposit $\$1000$ to Bob Account
\end{enumerate}
